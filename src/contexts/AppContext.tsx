...
const translations = {
  en: {
    ...
    'kpi.portfolio_value': 'Portfolio Value',
    'kpi.daily_pnl': 'Daily P&L',
    'kpi.portfolio_delta': 'Portfolio Delta',
    'kpi.avg_ytm': 'Avg YTM',
    'kpi.avg_implied_vol': 'Avg Implied Vol',
    'kpi.portfolio_vega': 'Portfolio Vega',
    'kpi.portfolio_gamma': 'Portfolio Gamma',
    'kpi.avg_prime': 'Avg Prime',
    'kpi.avg_duration': 'Avg Duration',
    'kpi.avg_credit_spread': 'Avg Credit Spread',
    'kpi.subtitle_eur': 'EUR',
    'kpi.subtitle_vs_yesterday': 'vs Yesterday',
    'kpi.subtitle_equity_exposure': 'Equity Exposure',
    'kpi.subtitle_yield_to_maturity': 'Yield to Maturity',
    'kpi.subtitle_balanced_profile': 'Balanced Profile',
    'kpi.subtitle_vol_sensitivity': 'Vol Sensitivity',
    'kpi.subtitle_convexity': 'Convexity',
    'kpi.subtitle_conversion_premium': 'Conversion Premium',
    'kpi.subtitle_interest_rate_risk': 'Interest Rate Risk',
    'kpi.subtitle_bond_profile': 'Bond Profile',
    ...
    'widget.top_worst_performers': 'Top & Worst Performers',
    'widget.top_3': 'Top 3',
    'widget.worst_3': 'Worst 3',
  ...
  fr: {
    ...
    'kpi.portfolio_value': 'Valeur du portefeuille',
    'kpi.daily_pnl': 'P&L quotidien',
    'kpi.portfolio_delta': 'Delta du portefeuille',
    'kpi.avg_ytm': 'TRM moyen',
    'kpi.avg_implied_vol': 'Vol implicite moy.',
    'kpi.portfolio_vega': 'Vega du portefeuille',
    'kpi.portfolio_gamma': 'Gamma du portefeuille',
    'kpi.avg_prime': 'Prime moyenne',
    'kpi.avg_duration': 'Durée moyenne',
    'kpi.avg_credit_spread': 'Spread crédit moy.',
    'kpi.subtitle_eur': 'EUR',
    'kpi.subtitle_vs_yesterday': 'vs hier',
    'kpi.subtitle_equity_exposure': 'Exposition actions',
    'kpi.subtitle_yield_to_maturity': 'Rendement à échéance',
    'kpi.subtitle_balanced_profile': 'Profil équilibré',
    'kpi.subtitle_vol_sensitivity': 'Sensibilité vol',
    'kpi.subtitle_convexity': 'Convexité',
    'kpi.subtitle_conversion_premium': 'Prime de conversion',
    'kpi.subtitle_interest_rate_risk': 'Risque de taux',
    'kpi.subtitle_bond_profile': 'Profil obligation',
    ...
    'widget.top_worst_performers': 'Meilleurs & pires performances',
    'widget.top_3': 'Top 3',
    'widget.worst_3': 'Pires 3',
